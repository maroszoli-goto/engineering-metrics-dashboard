...
class TestMapGithubToJiraUsername:
    ...
    def test_new_format_finds_matching_user(self):
        ...
        teams = [
            {
                "name": "Backend",
                "members": [{"github": "alice", "jira": "alice.jira"}, {"github": "bob", "jira": "bob.jira"}],
            }
        ]
    ...
    def test_old_format_finds_matching_user_by_index(self):
        ...
        teams = [
            {
                "name": "Backend",
                "github": {"members": ["alice", "bob", "charlie"]},
                "jira": {"members": ["alice.jira", "bob.jira", "charlie.jira"]},
            }
        ]
    ...
    def test_returns_none_when_user_not_found(self):
        ...
        teams = [
            {
                "name": "Backend",
                "github": {"members": ["alice", "bob"]},
                "jira": {"members": ["alice.jira", "bob.jira"]},
            }
        ]
    ...
    def test_searches_multiple_teams(self):
        ...
        teams = [
            ...
            {
                "name": "Frontend",
                "github": {"members": ["charlie", "david"]},
                "jira": {"members": ["charlie.jira", "david.jira"]},
            },
        ]
    ...
    def test_new_format_takes_precedence_over_old_format(self):
        ...
        teams = [
            {
                "name": "Backend",
                "members": [{"github": "alice", "jira": "alice.new.jira"}],
                "github": {"members": ["alice"]},
                "jira": {"members": ["alice.old.jira"]},
            }
        ]
    ...
    def test_handles_empty_github_members_list(self):
        # Arrange
        teams = [{"name": "Backend", "github": {"members": []}, "jira": {"members": []}}]
    ...
    def test_new_format_with_missing_jira_key_returns_none(self):
        # Arrange
        teams = [{"name": "Backend", "members": [{"github": "alice"}]}]  # Missing 'jira' key
    ...
    def test_mixed_format_members_list(self):
        ...
        teams = [
            {
                "name": "Backend",
                "members": [{"github": "alice", "jira": "alice.jira"}, "bob"],  # String instead of dict (malformed)
            }
        ]
