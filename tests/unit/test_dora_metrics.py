...
class TestDeploymentFrequency:
    ...
    def test_deployment_frequency_low_level(self):
        ...
        releases = [
            {'tag_name': 'v1.0.0', 'environment': 'production',
             'published_at': datetime(2025, 1, 1), 'repo': 'test/repo'},
            {'tag_name': 'v1.0.1', 'environment': 'production',
             'published_at': datetime(2025, 3, 31), 'repo': 'test/repo'}
        ]
    ...
    def test_deployment_frequency_filters_production_only(self):
        ...
        releases = [
            {'tag_name': 'v1.0.0', 'environment': 'production',
             'published_at': datetime(2025, 1, 1), 'repo': 'test/repo'},
            {'tag_name': 'v1.0.1-rc1', 'environment': 'staging',
             'published_at': datetime(2025, 1, 2), 'repo': 'test/repo'},
            {'tag_name': 'v1.0.1', 'environment': 'production',
             'published_at': datetime(2025, 1, 3), 'repo': 'test/repo'},
            {'tag_name': 'v1.0.2-beta', 'environment': 'staging',
             'published_at': datetime(2025, 1, 4), 'repo': 'test/repo'},
        ]
...
class TestLeadTimeForChanges:
    ...
    def test_lead_time_maps_pr_to_next_release(self):
        ...
        prs = [
            {'pr_number': 1, 'merged': True,
             'merged_at': datetime(2025, 1, 1, 10, 0), 'author': 'user1'},
            {'pr_number': 2, 'merged': True,
             'merged_at': datetime(2025, 1, 2, 10, 0), 'author': 'user1'},
            {'pr_number': 3, 'merged': True,
             'merged_at': datetime(2025, 1, 5, 10, 0), 'author': 'user1'},
        ]

        releases = [
            {'tag_name': 'v1.0.0', 'environment': 'production',
             'published_at': datetime(2025, 1, 3, 10, 0), 'repo': 'test/repo'},  # Gets PRs 1 & 2
            {'tag_name': 'v1.0.1', 'environment': 'production',
             'published_at': datetime(2025, 1, 6, 10, 0), 'repo': 'test/repo'},  # Gets PR 3
        ]
    ...
    def test_lead_time_ignores_unmerged_prs(self):
        ...
        prs = [
            {'pr_number': 1, 'merged': True,
             'merged_at': datetime(2025, 1, 1, 10, 0), 'author': 'user1'},
            {'pr_number': 2, 'merged': False,
             'merged_at': None, 'author': 'user1'},
        ]

        releases = [{
            'tag_name': 'v1.0.0', 'environment': 'production',
            'published_at': datetime(2025, 1, 2, 10, 0), 'repo': 'test/repo'}
        ]
...
class TestDORAMeasurementPeriod:
    ...
    def test_measurement_period_explicit_dates(self):
        ...
        releases = [{
            'tag_name': 'v1.0.0', 'environment': 'production',
            'published_at': datetime(2025, 1, 15), 'repo': 'test/repo'
        }]
