...
def generate_sample_reviews(count=10):
    ...
    return pd.DataFrame(
        {
            "reviewer": ["alice", "bob", "alice", "charlie", "bob", "alice", "charlie", "bob", "alice", "charlie"][
                :count
            ],
    ...
    return pd.DataFrame(
        {
            ...
            "author": ["alice", "bob", "alice", "charlie", "bob", "alice", "charlie", "bob", "alice", "charlie"][
                :count
            ],
...
def get_github_graphql_error_response():
    ...
    return {"errors": [{"message": "API rate limit exceeded", "type": "RATE_LIMITED"}]}
...
def get_jira_issue_response():
    ...
    return {
        ...
        "fields": {
            ...
            "status": {"name": "Done"},
            "assignee": {"displayName": "Alice Developer", "name": "alice.jira"},
