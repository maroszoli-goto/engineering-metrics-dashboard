    ...
    return {
        ...
        'teams': {
            'Native': {
                ...
                'members': [
                    {'name': 'John Doe', 'github': 'jdoe', 'jira': 'jdoe',
                     'prs_created': 10, 'reviews_given': 50, 'commits': 60}
                ]
            },
            'WebTC': {
...
def mock_cache(monkeypatch, mock_cache_data):
    ...
    # Mock the cache
    monkeypatch.setattr('src.dashboard.app.metrics_cache', {
